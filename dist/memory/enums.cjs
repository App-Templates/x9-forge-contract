...
exports.InvalidationReasonSchema = exports.MemoryCorrectiveActionSchema = exports.MemoryStatusSchema = exports.MemoryTypeSchema = exports.MemoryScopeSchema = void 0;
 ...
 */
exports.MemoryScopeSchema = zod_1.z.enum(['platform', 'owner', 'agent', 'user']);
/**
 ...
 */
exports.MemoryTypeSchema = zod_1.z.enum(['profile', 'procedural', 'episodic', 'relationship']);
/**
 ...
 */
exports.MemoryStatusSchema = zod_1.z.enum([
    'draft',
    'active',
    'invalidated',
    'superseded',
 ...
 */
exports.MemoryCorrectiveActionSchema = zod_1.z.enum([
    'invalidate',
    'forget',
    'redact',
    'pin',
 ...
 */
exports.InvalidationReasonSchema = zod_1.z.enum([

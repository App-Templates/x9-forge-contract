 ...
 * ```
 */
export const makeListResponseSchema = (row) => z.object({
    ok: z.literal(true),
    entries: z.array(row),
 ...
 * See ADR-memory-engine-v2.md §22 Phase 5.
 */
export const MemoryConsoleEpisodesResponseSchema = makeListResponseSchema(MemoryConsoleEpisodeSchema);
/**
 ...
 * See ADR-memory-engine-v2.md §22 Phase 5.
 */
export const MemoryConsoleAliasesResponseSchema = makeListResponseSchema(MemoryConsoleAliasSchema);
/**
 * MemoryConsoleFeedbackResponseSchema — list envelope for `memory_feedback` console reads.
 *
 * See ADR-memory-engine-v2.md §22 Phase 5.
 */
export const MemoryConsoleFeedbackResponseSchema = makeListResponseSchema(MemoryConsoleFeedbackSchema);

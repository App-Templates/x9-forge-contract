...
exports.internalAgentSendContract = exports.InternalAgentSendErrorResponseSchema = exports.InternalAgentSendResponseSchema = exports.InternalAgentSendRequestSchema = exports.InternalAgentSendParamsSchema = void 0;
 ...
 */
exports.InternalAgentSendParamsSchema = zod_1.z.object({
    /** Target agent slug (= agentId). Lowercase alphanumeric + dash. */
    agentId: zod_1.z.string().regex(/^[a-z0-9-]+$/),
});
exports.InternalAgentSendRequestSchema = zod_1.z.object({
    /**
...
exports.InternalAgentSendResponseSchema = zod_1.z.object({
    ok: zod_1.z.literal(true),
    /** Telegram message id of the sent message (from the bot.api.sendMessage result). */
    messageId: zod_1.z.number().optional(),
});
exports.InternalAgentSendErrorResponseSchema = zod_1.z.object({
    ok: zod_1.z.literal(false),
    error: zod_1.z.string(),
});
exports.internalAgentSendContract = {
    method: 'POST',
    path: '/internal/agents/:agentId/send',
    authType: 'secret',
    paramsSchema: exports.InternalAgentSendParamsSchema,
    bodySchema: exports.InternalAgentSendRequestSchema,
    responseSchema: exports.InternalAgentSendResponseSchema,
};

...
export const FORGE_VOICE_WEBHOOK_POST_CALL_PATH = '/webhooks/elevenlabs/post-call';
export const FORGE_VOICE_WEBHOOK_POST_CALL_METHOD = 'POST';
// -- Forge -> cap-voice internal forward -----------------------------------
export const CAP_VOICE_INTERNAL_POST_CALL_PATH = '/internal/voice/post-call';
export const CAP_VOICE_INTERNAL_POST_CALL_METHOD = 'POST';
// -- cap-voice call-start (outbound init, X9-initiated) --------------------
export const CAP_VOICE_CALL_START_PATH = '/call-start';
export const CAP_VOICE_CALL_START_METHOD = 'POST';
 ...
 */
export const CAP_VOICE_CALL_TOOL_PATH = (tool) => `/call/${tool}`;
export const CAP_VOICE_CALL_TOOL_METHOD = 'POST';
/**
 ...
 */
export const CAP_VOICE_CALL_TOOL_PATHS = Object.freeze(Object.fromEntries(VoiceToolNameSchema.options.map((tool) => [tool, CAP_VOICE_CALL_TOOL_PATH(tool)])));
 ...
 */
export const CAP_VOICE_PREPARE_CALL_PATH = '/call/voice_prepare_call';
export const CAP_VOICE_PREPARE_CALL_METHOD = 'POST';
 ...
 */
export const CAP_VOICE_ADMIN_SWEEP_HOLDS_PATH = '/internal/admin/sweep-holds';
export const CAP_VOICE_ADMIN_SWEEP_HOLDS_METHOD = 'POST';

...
exports.VaultEntryEncryptedSchema = exports.VaultEntryPlainSchema = exports.AES_WIRE_FORMAT_REGEX = void 0;
 ...
 */
exports.AES_WIRE_FORMAT_REGEX = /^[0-9a-f]{24}:[0-9a-f]{32}:[0-9a-f]{2,}$/;
...
const VaultEntryBase = zod_1.z.object({
     ...
     */
    createdAt: zod_1.z.string().datetime({ offset: true }).optional(),
});
/**
 ...
 */
exports.VaultEntryPlainSchema = VaultEntryBase.extend({
    value: zod_1.z.string(),
    isSecret: zod_1.z.boolean(),
}).refine((data) => !(data.isSecret && exports.AES_WIRE_FORMAT_REGEX.test(data.value)), { message: 'Plain secret value matches AES wire format — decrypt was not performed?' });
/**
 ...
 */
exports.VaultEntryEncryptedSchema = VaultEntryBase.extend({
    value: zod_1.z.string().regex(exports.AES_WIRE_FORMAT_REGEX, { message: AES_WIRE_FORMAT_ERROR }),
    isSecret: zod_1.z.literal(true),
});

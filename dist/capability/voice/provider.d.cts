...
export declare const OPENAI_LIVE_MODEL = "gpt-live-1";
/** Stock OpenAI voice recommended by the docs for quality. */
export declare const OPENAI_LIVE_DEFAULT_VOICE = "marin";
/**
 ...
 */
export declare const OPENAI_LIVE_DEFAULT_BACKEND_MODEL = "gpt-5.6-terra";

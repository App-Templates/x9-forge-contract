 ...
 */
export declare const ElevenLabsPostCallTranscriptionEventSchema: z.ZodObject<{
    type: z.ZodLiteral<"post_call_transcription">;
    event_timestamp: z.ZodOptional<z.ZodNumber>;
    data: z.ZodUnknown;
}, z.core.$loose>;
export type ElevenLabsPostCallTranscriptionEvent = z.infer<typeof ElevenLabsPostCallTranscriptionEventSchema>;
/**
 ...
 */
export declare const ElevenLabsPostCallAudioEventSchema: z.ZodObject<{
    type: z.ZodLiteral<"post_call_audio">;
    event_timestamp: z.ZodOptional<z.ZodNumber>;
    data: z.ZodUnknown;
}, z.core.$loose>;
export type ElevenLabsPostCallAudioEvent = z.infer<typeof ElevenLabsPostCallAudioEventSchema>;
/**
 ...
 */
export declare const ElevenLabsCallInitiationFailureEventSchema: z.ZodObject<{
    type: z.ZodLiteral<"call_initiation_failure">;
    event_timestamp: z.ZodOptional<z.ZodNumber>;
    data: z.ZodUnknown;
}, z.core.$loose>;
export type ElevenLabsCallInitiationFailureEvent = z.infer<typeof ElevenLabsCallInitiationFailureEventSchema>;

...
exports.ElevenLabsCallInitiationFailureEventSchema = exports.ElevenLabsPostCallAudioEventSchema = exports.ElevenLabsPostCallTranscriptionEventSchema = exports.ElevenLabsWebhookEventTypeSchema = void 0;
 ...
 */
exports.ElevenLabsWebhookEventTypeSchema = zod_1.z.enum([
 ...
 */
exports.ElevenLabsPostCallTranscriptionEventSchema = zod_1.z
    .object({
    type: zod_1.z.literal('post_call_transcription'),
    event_timestamp: zod_1.z.number().optional(),
 ...
 */
exports.ElevenLabsPostCallAudioEventSchema = zod_1.z
    .object({
    type: zod_1.z.literal('post_call_audio'),
    event_timestamp: zod_1.z.number().optional(),
    data: zod_1.z.unknown(),
})
    .passthrough();
 ...
 */
exports.ElevenLabsCallInitiationFailureEventSchema = zod_1.z
    .object({
    type: zod_1.z.literal('call_initiation_failure'),
    event_timestamp: zod_1.z.number().optional(),
    data: zod_1.z.unknown(),
})
    .passthrough();

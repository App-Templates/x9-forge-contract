...
exports.VoiceCallMemoryIngestPayloadSchema = void 0;
const zod_1 = require("zod");
const privacy_js_1 = require("./privacy.cjs");
const outcome_js_1 = require("./outcome.cjs");
/**
 ...
 */
exports.VoiceCallMemoryIngestPayloadSchema = zod_1.z.object({
    ...
    source_ref: zod_1.z.string().min(1),
    ...
    transcript_metadata: zod_1.z
        .object({
        duration_sec: zod_1.z.number().nonnegative().optional(),
        speaker_turns: zod_1.z.number().int().nonnegative().optional(),
     ...
     */
    analysis_raw_from_elevenlabs: zod_1.z.unknown().optional(),
    /** Reconciled outcome — canonical per D-09. */
    outcome_reconciled: outcome_js_1.VoiceCallOutcomeSchema,
    /** Privacy envelope (retention_class, privacy_level, jurisdiction flags). */
    privacy: privacy_js_1.VoicePrivacyMetadataSchema,
    /** RFC-3339 — when cap-voice asserted this fact (usually call end time). */
    asserted_at: zod_1.z.string().datetime({ offset: true }),
    /** RFC-3339 — when the observed fact happened (usually call start time). */
    source_observed_at: zod_1.z.string().datetime({ offset: true }),
});

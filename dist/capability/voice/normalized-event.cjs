 ...
 */
exports.ForgeVoiceWebhookNormalizedEventSchema = zod_1.z.object({
    ...
    event_type: webhook_events_js_1.ElevenLabsWebhookEventTypeSchema,
    ...
    forwarded_at: zod_1.z.string().datetime({ offset: true }).optional(),
    /** SHA-256 hash of the raw ElevenLabs payload (for dedupe + audit). */
    raw_event_hash: zod_1.z.string().min(1),
    /**

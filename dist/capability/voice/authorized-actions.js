 ...
 */
export const AuthorizedActionsSchema = z.object({
    // -- read-only defaults TRUE -------------------------------------------
    can_search_context: z.boolean().default(true),
    can_get_calendar_availability: z.boolean().default(true),
    can_check_calendar_conflicts: z.boolean().default(true),
    can_release_calendar_block: z.boolean().default(true),
    can_draft_email: z.boolean().default(true),
    can_notify_stefano: z.boolean().default(true),
    // -- mutating defaults FALSE -------------------------------------------
    can_update_calendar: z.boolean().default(false),
    can_create_calendar_event: z.boolean().default(false),
    can_block_calendar_slot: z.boolean().default(false),
    can_send_email_recap: z.boolean().default(false),
    can_create_reminder: z.boolean().default(false),
    // -- always-forbidden-unless-explicit defaults FALSE -------------------
    can_commit_costs: z.boolean().default(false),
    can_cancel_services: z.boolean().default(false),
    can_accept_contract_terms: z.boolean().default(false),
    /**
     ...
     */
    can_share_sensitive_pii: z.boolean().default(false),
    /**
     ...
     */
    can_act_outside_brief: z.boolean().default(false),
});

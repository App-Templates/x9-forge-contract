 ...
 */
exports.CAP_STT_DEFAULT_PORT = 4011;
/**
 ...
 */
exports.TranscribeRequestSchema = zod_1.z.object({
    telegramFileUrl: zod_1.z.string().url(),
    durationSec: zod_1.z.number().int().nonnegative().max(60),
 ...
 */
exports.TranscribeResponseSchema = zod_1.z.object({
    text: zod_1.z.string().min(1),
    language: zod_1.z.string().min(2),
    durationSec: zod_1.z.number().int().nonnegative(),
    provider: exports.TranscribeProviderSchema,
});

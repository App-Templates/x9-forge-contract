 ...
 */
exports.CapabilityRegistryEntrySchema = zod_1.z.object({
    ...
    tools: zod_1.z.array(capability_tool_js_1.CapabilityToolSchema).optional(),
    /**
     ...
     */
    modelPolicy: model_policy_js_1.ModelPolicySchema.optional(),
    /**
 ...
 */
function fromEndpoint(endpoint, meta) {

...
exports.agentWorkspacePath = agentWorkspacePath;
exports.agentRegistryPath = agentRegistryPath;
exports.agentContextJsonPath = agentContextJsonPath;
 ...
 */
function agentWorkspacePath(dataDir, agentId) {
 ...
 */
function agentRegistryPath(dataDir, agentId) {
...
function agentContextJsonPath(dataDir, agentId) {

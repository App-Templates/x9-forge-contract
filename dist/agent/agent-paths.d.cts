 ...
 */
export declare function agentWorkspacePath(dataDir: string, agentId: string): string;
/**
 ...
 */
export declare function agentRegistryPath(dataDir: string, agentId: string): string;
/** Absolute path to an agent's context.json (sibling of registry.json). */
export declare function agentContextJsonPath(dataDir: string, agentId: string): string;

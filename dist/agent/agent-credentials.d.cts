 ...
 */
export declare const KNOWN_CREDENTIAL_KEYS: readonly ["OPENAI_API_KEY", "ANTHROPIC_API_KEY", "GOOGLE_API_KEY", "AGENT_CHAT_MODEL", "TELEGRAM_BOT_TOKEN", "ELEVENLABS_API_KEY", "ELEVENLABS_VOICE_ID", "ELEVENLABS_MODEL_ID", "TTS_PROVIDER", "OPENAI_TTS_MODEL", "OPENAI_TTS_VOICE", "STT_PRIMARY_PROVIDER", "OPENAI_STT_MODEL", "VOICE_CALL_PROVIDER", "OPENAI_LIVE_VOICE", "OPENAI_LIVE_BACKEND_MODEL", "TELNYX_API_KEY", "TELNYX_CONNECTION_ID", "TELNYX_FROM_NUMBER", "TELNYX_PUBLIC_KEY", "LIVE_WEB_AUTH_TOKEN", "ELEVENLABS_MINDFULNESS_AGENT_ID", "FORGE_VOICE_REGISTER_TOKEN", "AGENTMAIL_API_KEY", "AGENTMAIL_INBOX_ID", "AGENT_EMAIL", "GOOGLE_CALENDAR_CLIENT_ID", "GOOGLE_CALENDAR_CLIENT_SECRET", "GOOGLE_CALENDAR_REFRESH_TOKEN", "INTERNAL_SECRET", "X9_INTERNAL_SECRET"];

import { type AgentContextCore } from "./agent-context-core.cjs";
/**
 ...
 * @see AGNT-05
 */
export declare function parseAgentContext(json: unknown): AgentContextCore;
//# sourceMappingURL=parse-agent-context.d.ts.map
 ...
 */
export const MEMORY_DELETE_BY_SOURCE_REF_PATH =
  '/internal/memory/delete-by-source-ref' as const;
...
export type MemoryDeleteBySourceRefRequest = z.infer<
  typeof MemoryDeleteBySourceRefRequestSchema
>;

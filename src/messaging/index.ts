...
export type { ChannelType } from './channel-type.js';

export { IncomingMessageAttachmentSchema } from './attachment.js';
export type { IncomingMessageAttachment } from './attachment.js';

export { IncomingMessageEnvelopeSchema } from './incoming-message-envelope.js';
export type { IncomingMessageEnvelope } from './incoming-message-envelope.js';

export { AgentEmailInboxSchema } from './agent-email-inbox.js';
export type { AgentEmailInbox } from './agent-email-inbox.js';

export { AgentTelegramBotSchema } from './agent-telegram-bot.js';
export type { AgentTelegramBot } from './agent-telegram-bot.js';

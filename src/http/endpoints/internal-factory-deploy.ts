...
export type InternalFactoryDeployResponse = z.infer<
  typeof InternalFactoryDeployResponseSchema
>;
...
export type InternalFactoryDeployErrorResponse = z.infer<
  typeof InternalFactoryDeployErrorResponseSchema
>;

export const internalFactoryDeployContract = {
  method: 'POST' as const,
  path: '/api/internal/factory/deploy' as const,

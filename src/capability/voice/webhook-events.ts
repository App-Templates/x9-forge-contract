...
export const ElevenLabsPostCallTranscriptionEventSchema = z
  ...
  .passthrough();
export type ElevenLabsPostCallTranscriptionEvent = z.infer<
  typeof ElevenLabsPostCallTranscriptionEventSchema
>;
...
export const ElevenLabsCallInitiationFailureEventSchema = z
  ...
  .passthrough();
export type ElevenLabsCallInitiationFailureEvent = z.infer<
  typeof ElevenLabsCallInitiationFailureEventSchema
>;

...
**Package:** `@x9-forge/contracts` · **Current version:** `1.21.1` (2026-09-12, Phase 50-06 — web live-voice ingress contracts; 1.20.0 same day: `VoiceProviderSchema` + `capability/voice-live`; 1.19.0: `capability/tts`) · **Foundation:** v1.0 shipped 2026-04-16 (git tag `v1.0` at `1d709a1`) · **Status:** active, additive releases per consuming phase

...
**Package:** `@x9-forge/contracts` · **Current version:** `1.19.0` (2026-09-12, Phase 50 — voice-note provider lanes `capability/tts` + stt defaults + 5 vault config keys) · **Foundation:** v1.0 shipped 2026-04-16 (git tag `v1.0` at `1d709a1`) · **Status:** active, additive releases per consuming phase

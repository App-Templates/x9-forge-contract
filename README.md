...
**Package:** `@x9-forge/contracts` · **Current version:** `1.18.0` (2026-07-03, X9-ATTACH-01 — optional attachment on internal-turn, `a70fe1c`) · **Foundation:** v1.0 shipped 2026-04-16 (git tag `v1.0` at `1d709a1`) · **Status:** active, additive releases per consuming phase
